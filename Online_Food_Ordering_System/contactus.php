...
<html>
  ...
  <head>
    <title> Contact | Food Craze </title>
  </head>
...
?>
    ...
    <div class="tagline">
     <h1 style="color: purple"><center><strong>Want to contact <span class="edit"> Food Craze </span>?</strong></center></h1>
     <br>
    <h2 style="color: black"><center>You can call us at 01234567890 or fill up the following form</center></h2>
    </div>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 32px;"> Contact Form</h3>
          ...
          <div class="form-group">
           ...
           <span class="help-block"><p id="characterLeft" class="help-block">Max Character length : 150 </p></span>
          </div> 
