...
<div class="container">
    <div class="jumbotron">
     <h1>Hello, Dear Manager! </h1> <!-- Hello, Dear Manager! -->
     <p> You can manage all of your restaurants from here</p> <!-- You can manage all of your restaurants from here -->
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    <div style="text-align: center;">
      <h3>Select Food to Edit <br><br><br></h3>
    </div>
    <?php
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 25px;"> Edit your Food from here </h3>
