<html>
<head>
    <title> Customer Registration | Food Craze </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hello Guest, <br> Welcome to <span class="edit"> Food Craze</span></h1>
     <br>
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="customer_registered_success.php" method="POST">
          ...
          <div class="form-group col-xs-12">
            <label for="fullname"><span class="text-danger" style="margin-right: 5px;">*</span> Name: </label>
            <div class="input-group">
              <input class="form-control" id="fullname" type="text" name="fullname" placeholder="Your Name" required="" autofocus="">
